...
import com.unexceptional.beast.banko.databinding.FragmentDebtShortcutsBinding;
...
public class DebtShortcutsFragment extends BasicFragment{

    private ProductEntity product;
    private OnFragmentInteractionListener mListener;
    private FragmentDebtShortcutsBinding mBinding;


    public DebtShortcutsFragment() {
     ...
     */
    public static DebtShortcutsFragment newInstance(long productId) {

        DebtShortcutsFragment fragment = new DebtShortcutsFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        mBinding= DataBindingUtil.inflate(inflater, R.layout.fragment_debt_shortcuts, container, false);
    ...
    private void setProductVisuals( ){
        ...
        if((Math.round(product.getBalance())<0d))
            mBinding.balance.setTextColor(Color.RED);
        else
            mBinding.balance.setTextColor( getResources().getColor(R.color.green));
    ...
    public String toString() {
        return Constants.TAG_DEBT_SHORTCUTS_FRAGMENT;
    }
    ...
    public interface OnFragmentInteractionListener {
        void editDebt(Product product);
        void borrowed(Product product);
        void boughtMe(Product product);
        void paidDebt(Product product);
