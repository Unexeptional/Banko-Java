...
import com.unexceptional.beast.banko.databinding.SemiComplexListBinding;
 ...
 * additionally having summary and list of inactive items
 * <p/>
 */
abstract class SemiComplexListFragment extends BasicListFragment {

    protected SemiComplexListBinding mBinding;

    /**
     * Mandatory empty constructor for the fragment manager to instantiate the
     * fragment (e.g. upon screen orientation changes).
     */
    public SemiComplexListFragment() {
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        mBinding= DataBindingUtil.inflate(inflater, R.layout.semi_complex_list,container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mBinding.inactiveButton.setText(setInactiveButtonText());
    ...
    protected abstract String setInactiveButtonText();
    protected abstract void setNewItemButton();
